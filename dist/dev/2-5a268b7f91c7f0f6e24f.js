	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            getFieldDecorator('domain', {
	                ...
	                rules: [{ required: true, message: '域名不能为空' }, { validator: (0, _validator2.default)([{ regExpStr: '^([a-zA-Z\\d][a-zA-Z\\d-_]+\\.)+[a-zA-Z\\d-_][^ ]*:[\\d]+$', message: '格式错误，例：docker.56qq.cn:5000' }]) }]
	            })(_react2.default.createElement(_input2.default, {
	                type: 'text',
	                autoComplete: 'off',
	    ...
	    return function (rule, value, callback) {
	        if (value) {
	            ...
	            for (; i < ii; ++i) {
	                ...
	                var name = (0, _keys2.default)(item)[0]; // 需要校验的规则必须放在对象第一位
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _dva.connect)(mapStateToProps)(RepoUpdate);
	module.exports = exports['default'];
